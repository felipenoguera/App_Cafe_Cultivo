...
public class MainActivity2 extends AppCompatActivity implements View.OnClickListener{
    ...
    private void readUser(){
        String URL = "http://192.168.1.9/crud/fetch.php?id=" + id;
    ...
    public void onClick(View v) {
        ...
        if (id == R.id.btnEdit) {
            ...
            Toast.makeText(MainActivity2.this, "Usuario Editado", Toast.LENGTH_SHORT).show();
    ...
    private void updateUser(final String name, final String email, final String password, final String phone) {
        String URL = "http://192.168.1.9/crud/edit.php";
    ...
    private void removeUser(final String idUser) {
        String URL = "http://192.168.1.9/crud/delete.php";
        StringRequest stringRequest = new StringRequest(
                Request.Method.POST,
                URL,
                new Response.Listener<String>() {
